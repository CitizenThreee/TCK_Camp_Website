...
export default function Home() {
    ...
    const [showHeroTextFallback, setShowHeroTextFallback] = useState(false);
                ...
                <div className='h-full overflow-y-auto'>
                    <div className='d-flex flex-column align-items-center justify-content-between h-container'>
                        <section className='p-2 my-auto w-100'>
                            <div className='p-3 bg-2b my-4 skewed-box mx-auto w-content '>
                                <h2 className='font-1 mb-0 text-center text-1'>
                            ...
                            <div className='pb-3 px-0 my-4 bg-2b skewed-box mx-auto w-content'>
                                ...
                                <div className='px-3'>
                                    {showHeroTextFallback && (
                                        <>
                                            <h2 className='font-1 mb-0 text-1'>{data.hometitle}</h2>
                                            <p className='m-0 pt-0 pb-2 text-1'>{data.homesubtitle}</p>
                                        </>
                                    )}
                                    <p className='fs-5 text-justify text-1' style={{ textAlign: 'justify' }}>
                                    ...
                                    <hr className='my-4'/>
                                    <h2 className='font-1 text-1'>A Little Bit Of Camp History:</h2>
                                    <p className='fs-5 text-justify text-1' style={{ textAlign: 'justify' }}>
